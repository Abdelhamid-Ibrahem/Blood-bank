                    ...
                    <form class="needs-validation" novalidate  method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-row">
                            ...
                            <input type="text" class="form-control" id="validationCustom02"
                                   ...
                                   value="abdelhami12d@gmail.com" required>
                        ...
                        <div class="form-row">
                            ...
                            <span class="calendar-btn"
                                  onclick="pureJSCalendar.open('dd/MM/yyyy',-10, -10, 1, '1800-5-5', '2024-8-10', 'BD', 20)">
                        ...
                        <div id="my-calendar"></div>
                            ...
                            {{ html()->select('governorate_id',$governorate->pluck('name','id')->toArray(),null,)
                                ->class ('custom-select custom-select-lg mb-3 mt-3 custom-width')
                                ->id('governorates')
                                ->placeholder( 'اختر محافظة')
                            }}

                            {{ html()->select('city_id',[],null,)
                                ->class( 'custom-select custom-select-lg mb-3 mt-3 custom-width')
                                ->id ('cities')
