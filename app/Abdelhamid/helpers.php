...
function responseJson($status, $msg, $data = null): JsonResponse
{
    $response = [
        'status' => $status,
        'msg' => $msg,
...
function notifyByFirebase($title,$body,$tokens,$data = []): bool|string        // paramete 5 =>>>> $type
{
...
function smsMisr($to, $message)
{
    ...
    curl_setopt($rest, CURLOPT_RETURNTRANSFER, 1); //by Abdelhamid to stop outputting result.
